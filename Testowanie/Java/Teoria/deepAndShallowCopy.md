...
2. Użycie kolekcji niemodyfikowalnych
...
3. Synchronizacja (dla bezpieczeństwa wątków)
...
4. Tworzenie głębokiej kopii (Deep Copy)
...
5. Przechowywanie w zmiennej final
